...
def check_airdrops():
    ...
    prompt = (
        ...
        "Provide all details, direct links, and clear step-by-step instructions on how to claim them. "
        "CRITICAL INSTRUCTION: You MUST write the ENTIRE response completely in Bengali (বাংলা). Do NOT use English except for technical link URLs."
    )
    
    # গুগলের নতুন এবং বর্তমান কার্যকর মডেল
